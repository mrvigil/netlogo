...
breed [sheep a-sheep]
patches-own [growth]
turtles-own [age health gender hunger thirst in-heat]
to setup
  clear-all
  reset-ticks
...
to make-sheep
  ...
  [
    ...
    set thirst random 50
    set gender one-of ["male" "female"]
    if gender = "male" [set color white]
    if gender = "female" 
    [
      set color pink
      set in-heat one-of ["yes" "no"]
    ]
  ]
end
to mv
  set thirst thirst + 0.1
  set health health - 1
  set age age + 0.01
  set size age / 10
  if health < 0 [die]
